"""PageIndex markdown-to-tree builder.

Vendored from https://github.com/VectifyAI/PageIndex/blob/main/pageindex/page_index_md.py
"""
...
from backend.services.pageindex.utils import (
    count_tokens, write_node_id, structure_to_list,
    generate_node_summary, format_structure,
