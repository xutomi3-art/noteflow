...
export default function NotebookPage() {
  ...
  }, [messages, streamingContent, isStreaming, thinkingSteps, isGenerating]);
          ...
          >
            <div className="max-w-3xl mx-auto" onClick={handleCitationClick}>
              ...
              <div className="space-y-8">
                ...
                {/* Skill generating indicators — show ALL that are generating */}
                {Object.entries(isGenerating).filter(([, v]) => v).map(([skillKey]) => {
                  ...
                  return (
                    <div key={skillKey} className="flex justify-start">
        ...
        <div className="fixed inset-0 bg-black/30 z-50 flex items-center justify-center" onClick={() => setIsCreateSkillOpen(false)}>
          <div className="bg-white rounded-2xl shadow-xl w-[460px] max-h-[80vh] overflow-hidden" onClick={(e) => e.stopPropagation()}>
            <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
              <h3 className="text-base font-semibold text-slate-900">{editingSkillId ? "Edit Skill" : "Create Custom Skill"}</h3>
            ...
            <div className="px-5 py-3 border-t border-slate-100 flex justify-end gap-2">
              ...
              >
                {isCreatingSkill ? (editingSkillId ? "Saving..." : "Creating...") : (editingSkillId ? "Save" : "Create")}
              </button>
            </div>
          </div>
        </div>
